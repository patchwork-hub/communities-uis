...
export const updateWrappedRoute = () => {
    ...
    const targetFilePath = path.join(projectRoot, "app/javascript/mastodon/features/ui/index.jsx");
    ...
    replaceContent(importStatements, `CommunitiesTimeline,\n${importStatements}`, targetFilePath);
